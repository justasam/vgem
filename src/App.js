...
class App extends Component {
  ...
  componentDidMount() {
    // let data = {rinka: {}, asmeninis: {}};
    // let startDate = moment().subtract(60, 'd').format('YYYY/MM/DD');
    // for (var i = 0; i < 60; i++) {
    //   data['rinka'][startDate] = {
    //       baterijos: {
    //         nupirkta: 0,
    //         ['paklausa-pasiula']: 0
    //       },
        ...
        <Content style={{backgroundColor: "white", padding: 10, maxWidth: "1920px", margin: "0 auto"}}>
          <Row gutter={40}>
            <Col span={8} xs={24} sm={24} md={24} lg={10} xl={10}>
              <Live />
              <List title={"Perka\nParduoda"} data={perkaParduoda} />
            </Col>
            <Col span={16} xs={24} sm={24} md={24} lg={14} xl={14} style={{padding: "20px"}}>
              <List title={"Parduota\nNupirkta"} data={parduotaNupirkta} />
              <Stats title="Asmeniniai Stats" data={data['asmeninis']}/>
              <Stats title="Rinkos Stats" data={data['rinka']} />
            </Col>
          </Row>
        </Content>
      </Layout>
